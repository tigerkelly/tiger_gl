...
extern UG_FONT FONT_CYRILLIC_8X12;
...
// Added by Kelly Wiles
UG_FONT *UG_GetFont(char *fontName);
UG_FONT *UG_CurrentFont(void);
UG_FONT *UG_FontSelectByName(char *fontName);
char *UG_Version(void);
